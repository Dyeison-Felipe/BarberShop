...
import { ClientFavoriteMongoRepository } from '../repositories/mongo/client-favorite-mongo.repository.js';
...
export class ClientFavoriteListModule implements IModule {
  buildModule(): BuildModule {
    ...
    // const clientFavoriteRepository = new ClientFavoriteMongoRepository();
